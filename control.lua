...
local modName = "StartWithBotsQOL"
...
function OnInit()
	...
	if remote.interfaces["freeplay"] then
		...
		if not settings.startup['disable-crashsite'].value then 
			...
			ship_items['fusion-construction-robot'] = (ship_items['fusion-construction-robot'] or 0) + 500
...
function GiveArmor(player)
	...
	player_inventory.insert{name="fusion-construction-robot", count = 500}
